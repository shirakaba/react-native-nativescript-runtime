...
class NativeInterface {
  static instance: NativeInterface | null = null;
  ...
  _debugging = false;
  _objectTracking: any = {};
  _isFunction: Record<string, boolean> = {};
  sendResponse: any;
...
/**
 * Although I've declared this in the module scope, it's only available from within ensureBroadCastReceiverClass().
 * I'm not sure how else to write the typing.
 */
declare class IBroadcastReceiver extends android.content.BroadcastReceiver {
  constructor(
    onReceiveCallback: (
...
let androidBroadcastReceiverClass: typeof IBroadcastReceiver;
...
export const androidBroadcastReceiverRegister = (
  ...
  const registerFunc = (context: android.content.Context) => {
    const receiver: android.content.BroadcastReceiver =
      new androidBroadcastReceiverClass(onReceiveCallback);
...
/**
 * Although I've declared this in the module scope, it's only available from within that if (global.android) conditional block.
 * I'm not sure how else to write the typing.
 */
declare class IDialogFragmentImplClass extends androidx.fragment.app
  .DialogFragment {
  id?: string | undefined;
 ...
 * I'm not sure how else to write the typing.
 */
declare class IDialogImplClass extends android.app.Dialog {
  constructor(
    fragment: any,
    ...
    implements IDialogFragmentImplClass
  {
    ...
    onCreateDialog(
      ...
      const dialog = new DialogImpl(
        this,
        global.androidCapacitorActivity,
        theme
      );
